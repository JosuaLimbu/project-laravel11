                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button" @click="isOpen = !isOpen"
                                ...
                                <img class="h-8 w-8 rounded-full" src="img/DSC00042.jpg" alt="">
                            </button>
                        </div>
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
                <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full" src="img/DSC00042.jpg" alt="">
                </div>
                <div class="ml-3">
                    <div class="text-base font-medium leading-none text-white">Josua Limbu</div>
                    <div class="text-sm font-medium leading-none text-gray-400">limbujosua23@gmail.com</div>
                </div>
