<x-layout>
                ...
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    <div class="relative w-full">
                        ...
                        <input
                            ...
                            placeholder="Search for project" type="search" id="search" name="search"
                            autocomplete="off">
                    </div>
                    <div>
                        <button type="submit"
    ...
    <div class="py-4 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-0">
        <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            @forelse ($posts as $post)
                <article
                    ...
                    <div class="flex justify-between items-center">
                        <a href="/posts?author={{ $post->author->username }}" class="hover:underline text-base">
            ...
            @empty
                <div>
                    <p class="font-semibold text-xl my-4">No project yet!. Please check back later.</p>
